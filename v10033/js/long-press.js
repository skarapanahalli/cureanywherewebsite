...
console.log('function start');
    ...
    document.addEventListener(mouseDown, function(e) {
        ...
        // get delay from html attribute if it exists, otherwise default to 10000
        var longPressDelayInMs = parseInt(el.getAttribute('data-long-press-delay') || '10000', 10);
